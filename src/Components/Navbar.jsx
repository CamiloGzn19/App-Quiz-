...
import { Footer, Logos,BtnNav } from "../styles/Navbar";
        ...
        <Footer>
          <Logos>
            <BtnNav as={Link} to="/categories">
              ...
              <p as={Link} to="/categories">
                Home
              </p>
            </BtnNav>
            <BtnNav as={Link} to="/stats">
              <svg
                width="24"
                height="24"
                viewBox="0 0 24 24"
